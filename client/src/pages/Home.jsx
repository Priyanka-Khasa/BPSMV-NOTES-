    ...
    <div ref={containerRef} className="space-y-0 -mx-4 sm:-mx-6 lg:-mx-8">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-white via-brand-50/30 to-parchment-light min-h-[90vh] flex items-center justify-center hero-pattern">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <h1 className="scroll-reveal scroll-reveal-delay-2 text-4xl sm:text-5xl lg:text-7xl font-display font-bold text-slate-900 mb-6 leading-tight tracking-tight hero-title">
            Your Academic<br />
          ...
          <p className="scroll-reveal scroll-reveal-delay-3 text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          {/* Quick stats */}
          <div className="scroll-reveal scroll-reveal-delay-5 grid grid-cols-3 gap-6 max-w-lg mx-auto mt-16">
            {[
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="scroll-reveal card p-8 hover:-translate-y-2 hover:shadow-xl transition-all duration-500"
